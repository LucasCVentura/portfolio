...
const icons = [Server, Monitor, Smartphone, Database, Cloud, Bot];
    ...
    <section id="skills" className="py-20 md:py-28 px-6 md:px-16 bg-[var(--navy)]">
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <h2 className="font-[family-name:var(--font-cinzel)] text-2xl font-bold text-[var(--text)] tracking-wide">{t.skills.title}</h2>
