...
export default function Nav() {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-16 py-5 transition-all duration-300 ${scrolled ? "backdrop-blur-xl bg-[#020b18]/80 border-b border-[var(--border)]" : ""}`}>
